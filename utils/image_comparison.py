'''Original code: https://github.com/fcakyon/streamlit-image-comparison'''
...
def image_comparison(
    ...
    htmlcode = f"""
        {css_block}
        {js_block}
        <div id="foo"style="height: {height}; width: 100%;"></div>
        <script>
    ...
    # Render component
    components.html(htmlcode, height=height, width=width)